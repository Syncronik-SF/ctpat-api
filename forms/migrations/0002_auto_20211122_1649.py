    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('guardia_entrada', models.CharField(blank=True, max_length=50, null=True)),
                ('guardia_salida', models.CharField(blank=True, max_length=50, null=True)),
                ('id_formulario', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='forms.formulario')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('placas', models.CharField(blank=True, max_length=30, null=True)),
                ('id_formulario', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='forms.formulario')),
            ],
        ),
    ]
